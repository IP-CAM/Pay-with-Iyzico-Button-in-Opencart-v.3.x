...
class ModelExtensionModulePaywithiyzicobutton extends Model {

    public function install() {
        $this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "paywithiyzicobutton_order` (
...
// card ?
     /*   $this->db->query("
			CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "paywithiyzicobutton_card` (
    ...
    public function uninstall() {
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "paywithiyzicobutton_order`;");
        //$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "paywithiyzicobutton_card`;");
    }
    ...
    public function apiConnection($authorization_data,$api_connection_object) {
        ...
        $url 		= $this->config->get('module_paywithiyzicobutton_api_url');
